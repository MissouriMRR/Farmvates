# Contributing to drone-mission-template
...
- Make sure your pull requests clearly describe changes made on your branch compared to
  the develop branch.
- In order to merge your branch into the `develop` branch, you must pass our pre-commit
  checks.
